.PHONY: dissertation clean distclean release

init: clean dissertation

dissertation:
	#	$(MAKE) -C Dissertation
	latexmk -pdf -pdflatex="xelatex -interaction nonstopmode" dissertation
